Gem::Specification.new do |s|
  ...
  s.files = ["bin/github", "commands/commands.rb", "commands/helpers.rb", "lib/extensions.rb", "lib/github/command.rb", "lib/github/helper.rb", "lib/github.rb", "LICENSE", "README", "spec/command_spec.rb", "spec/extensions_spec.rb", "spec/github_spec.rb", "spec/helper_spec.rb", "spec/spec_helper.rb", "spec/ui_spec.rb", "Manifest", "github.gemspec"]
  s.has_rdoc = true
